...
<body>
    <div class="container">
        <h1><b>Ordered Address - Database Records</b></h1>
        <table>
            <thead>
                <tr>
                    <th>ID</th>
            ...
            <tbody>
                ...
                $sql = "SELECT product, name, phone, pincode, houseno, street, landmark, city, state, payment FROM address";
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        echo "<tr>";
                        echo "<td>".$counter."</td>"; // Display the counter as I
